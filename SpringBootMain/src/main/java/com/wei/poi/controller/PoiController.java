package com.wei.poi.controller;
...
import com.wei.poi.model.WordParam;
import com.wei.poi.utils.FileUtil;
import com.wei.poi.utils.PoiUtil;
import com.wei.utils.excel.ConvertUtils;
...
public class PoiController extends BaseController {
	...
	public ResponseEntity<byte[]> build(WordParam wordParam) throws IOException {
		...
		Map<String, Object> map = ConvertUtils.toMap(wordParam);
