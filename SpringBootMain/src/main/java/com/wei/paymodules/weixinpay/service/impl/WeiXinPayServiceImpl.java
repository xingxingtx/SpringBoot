...
import com.wei.paymodules.weixinpay.util.HttpUtil;
import com.wei.paymodules.weixinpay.util.PayCommonUtil;
import com.wei.paymodules.weixinpay.util.XMLUtil;
import com.wei.paymodules.weixinpay.util.mobile.ClientCustomSSL;
...
public class WeiXinPayServiceImpl implements IWeiXinPayService {
    ...
    @Override
    public String
    weixinPayMobile(Product product) {
        String totalFee = product.getTotalFee();
